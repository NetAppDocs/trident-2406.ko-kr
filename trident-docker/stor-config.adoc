...
FlexGroups 및 FlexGroups에 적합한 워크로드에 대한 자세한 내용은  https://www.netapp.com/pdf.html?item=/media/12385-tr4571.pdf["NetApp FlexGroup 볼륨 모범 사례 및 구현 가이드 를 참조하십시오"^]을 참조하십시오.
