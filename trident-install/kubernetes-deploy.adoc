...
수동으로 배포하든 Helm을 사용하든, Trident Operator는 Astra Trident 리소스를 설치하고 동적으로 관리하는 데 매우 유용한 도구입니다. link:kubernetes-customize-deploy.html["Trident 운영자 배포를 사용자 지정합니다"] `TridentOrchestrator` 사용자 정의 리소스(CR)의 속성을 활용할 수도 있습니다.
