...
.이 작업에 대해
* 업그레이드 후 발견된 버그, 종속성 문제 또는 업그레이드 실패나 불완전한 업그레이드에 대한 수정이 필요한 경우, Astra Trident를 제거하고 이전 버전의 설치 지침에 따라 이전 버전을 다시 설치해야 합니다. 이것이 이전 버전으로 _다운그레이드_하는 유일하게 권장되는 방법입니다.
